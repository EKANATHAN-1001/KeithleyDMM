classdef Limit < instrument.ivicom.Interface
    ...
    methods
        ...
        function val = Audible(obj,LimitTest,Function,newValue)
            %AUDIBLE This property enables or disables a beeper that sounds when a limit is exceeded.
        ...
        function val = ChannelAudible(obj,LimitTest,Function,ChannelList,newValue)
            %CHANNELAUDIBLE This property enables or disables a beeper that sounds when a limit is exceeded.
